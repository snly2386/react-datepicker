...
var longFormatters_1 = createCommonjsModule(function(e, t) {
    function r(e, t) {
      switch (e) {
        case "P":
  ...
  longFormatters = unwrapExports(longFormatters_1),
        ...
        _defineProperty(_assertThisInitialized(r), "renderTimes", function() {
          for (
            var e = [],
              ...
              n = r.props.intervals,
              a = r.props.selected ? r.props.selected : newDate(),
              o = getHours(a),
              i = getMinutes(a),
            ...
            var d = addMinutes(s, l * n);
            if ((e.push(d), c)) {
              var u = timesToInjectAfter(s, d, l, n, c);
              e = e.concat(u);
            }
          }
          return e.map(function(e, n) {
            return React.createElement(
              "li",
              {
                ...
                ref: function(t) {
                  ((o === getHours(e) && i === getMinutes(e)) ||
                    (o === getHours(e) && !r.centerLi)) &&
                    (r.centerLi = t);
                }
              },
    ...
    function t(e) {
      ...
      return (
        ...
        _defineProperty(
          ...
          function() {
            if (!r.props.renderCustomHeader) {
              var e = monthDisabledBefore(r.state.date, r.props);
              if (
        ...
        _defineProperty(
          ...
          function() {
            if (!r.props.renderCustomHeader) {
              var e = monthDisabledAfter(r.state.date, r.props);
              if (
                (r.props.forceShowMonthNavigation ||
                  r.props.showDisabledMonthNavigation ||
                  !e) &&
        ...
        _defineProperty(_assertThisInitialized(r), "renderMonths", function() {
          if (!r.props.showTimeSelectOnly) {
            for (var e = [], t = 0; t < r.props.monthsShown; ++t) {
              var n = t - r.props.monthSelectedIn,
                a = addMonths(r.state.date, n),
                o = "month-".concat(t);
              e.push(
                React.createElement(
                  "div",
                  ...
                  r.props.showMonthYearPicker || r.props.showQuarterYearPicker
                    ? r.renderYearHeader({ monthDate: a, i: t })
                    : r.props.renderCustomHeader
                    ? r.renderCustomHeader({ monthDate: a, i: t })
                    : r.renderDefaultHeader({ monthDate: a, i: t }),
