!(function(e, t) {
  ...
  function Me(e, t) {
    var r = t.hour,
      ...
      o = void 0 === a ? 0 : a,
      s = t.second;
    return E(N(P(e, void 0 === s ? 0 : s), o), n);
  }
  function Oe(e, t) {
    var r = Le(t || qe());
    return R(e, { locale: r });
            ...
            de(
              ...
              function() {
                return n.state.monthYearsList.map(function(e) {
                  var r = O(e),
                    a = Ne(n.props.date, e) && Ee(n.props.date, e);
                  return t.createElement(
                    "div",
                    {
                      className: a
      ...
      function r() {
        ...
        return (
          ...
          de(ye(n), "onChange", function(e) {
            n.toggleDropdown();
            var t = _e(parseInt(e));
            (Ne(n.props.date, t) && Ee(n.props.date, t)) || n.props.onChange(t);
          }),
          de(ye(n), "toggleDropdown", function() {
            return n.setState({ dropdownVisible: !n.state.dropdownVisible });
          }),
    ...
    Dt = (function(e) {
      function r(e) {
        ...
        return (
          ...
          de(ye(n), "setClickOutsideRef", function() {
